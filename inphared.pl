...
if (! -f "$vcontact_genus") {
    ...
    #Give it some headers
    print VGENUS "Node_ID\tName\tGenus\tColour (Genus)\n";
...
if (! -f "$vcontact_sub") {
    ...
    #Give it some headers
    print VSUB "Node_ID\tName\tSub-family\tColour (Sub-family)\n";
...
if (! -f "$vcontact_family") {
    ...
    #Give it some headers
    print VFAMILY "Node_ID\tName\tFamily\tColour (Family)\n";
...
if (! -f "$vcontact_lowest_taxa") {
    ...
    #Give it some headers
    print VLOWEST "Node_ID\tName\tLowest Taxa\tColour (Lowest taxa)\n";
...
if (! -f "$vcontact_host") {
    ...
    #Give it some headers
    print VHOST "Node_ID\tName\tHost\tColour (Host)\n";
